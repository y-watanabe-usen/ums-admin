...
//================================
// 環境設定
Configure::write('ENVIROMENT', 'dev');

// ドメイン設定
Configure::write('DOMAIN', 'dev-members.usen.com');

// 管理機能URL
Configure::write('ADMIN_URL', 'http://dev-admin-members.usen.com/');
...
Configure::write('MAIL_FROM_NAME', '[開発]pj-app-dev@usen.co.jp');
...
//サイトタイトル
Configure::write('WEB_NAME', 'Usen Members管理 - 開発環境');
