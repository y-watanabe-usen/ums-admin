...
//================================
// 環境設定
Configure::write('ENVIROMENT', 'prod');
...
// SMTPサーバ
Configure::write('MAIL_HOST', '10.223.12.62');
// メールのFROM
Configure::write('MAIL_FROM', 'pj-app-dev@usen.co.jp');
Configure::write('MAIL_FROM_NAME', 'pj-app-dev@usen.co.jp');

// 支店メールスイッチ（trueだと支店にメールを送る）
Configure::write('NOT_ARRIVED_MAIL_SWITCH', true);
...
//サイトタイトル
Configure::write('WEB_NAME', 'Usen Members管理');
...
Configure::write('OTORAKU_LISTENED_TIME_API', 'https://apiweb.otoraku.jp/secure_api/listened_time.php');
