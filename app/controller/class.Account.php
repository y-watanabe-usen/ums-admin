...
class Account extends Controller {
    ...
    public function detail_account_stop() {
        ...
        if (
            $service_cd == "100" ||
            ($service_cd == "120" && !is_null($service_info[0]["cont_no"]) && !is_null($service_info[0]["detail_no"])) ||
            ($service_cd == "180" && !is_null($service_info[0]["cont_no"]) && !is_null($service_info[0]["detail_no"]))
        ) {
            $unlock_flg = true;
        }
