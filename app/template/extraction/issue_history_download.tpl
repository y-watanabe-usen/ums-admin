...
<div class="main-title" style="left:210px;">アカウント証発送履歴抽出</div>
...
<form id="fr_dl" action="/extraction/issue_history_download" method="POST">
<input type="hidden" name="type" value="download" />
<table style="padding:0;margin:0;position:absolute;top:0;">
    <tr>
        <td colspan="2" style="height: 40px; vertical-align: top;">発送日のFrom~Toを入力してダウンロードしてください。</td>
    </tr>
    <tr>
        <td style="width: 130px; height: 30px;">発送日</td>
        <td>
