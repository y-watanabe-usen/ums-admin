...
<div class="main">
    ...
    <div class="main-panel" style="padding-top:22px">
        ...
        <div style="width:auto;height:100%;box-sizing: border-box;-moz-box-sizing: border-box;margin:0;padding-top:28px;overflow:hidden;">
            <div class="main-title" style="left:210px;">お試しアカウント発行</div>
            ...
            <div class="panel-base" style="height:100%;width:100%;overflow:hidden;">
                <div class="panel">
                    ...
                    <div class="unit" style="padding:53px 20px 10px 20px;height:100%;">
                        <form id="fr_dl" action="/dedicated/trial_create" method="POST">
                        ...
                        <table style="padding:0;margin:0;position:absolute;top:0;">
                            ...
                            <tr>
                                <td style="width: 100px; height: 30px;"><span class="required">件数</span></td>
                                <td>
                                    <input id="count" type="text" name="count" style="width:120px;" value="<?php echo Func::h($count); ?>">
                                </td>
                            </tr>
                            <tr>
                                <td style="width: 100px; height: 30px;"><span class="required">販路</span></td>
                                <td>
                            ...
                            <tr>
                                <td style="width: 100px; height: 30px;"><span class="required">トライアル日数</span></td>
                                <td>
                                    <select name="trial_days">
                                      <?php for ($i = 1; $i <= 31; $i++) { ?>
                                        <?php $selected = ""; ?>
                                        <?php if ($i == 14) { // 14日をデフォルト選択 ?>
                            ...
                            <tr>
                                <td colspan="2"><button id="bt_download" class="bt_mini" style="width: 200px;">お試しアカウントを発行する</button></td>
                            </tr>
                            <tr>
