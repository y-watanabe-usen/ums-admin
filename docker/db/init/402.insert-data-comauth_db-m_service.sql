...
INSERT INTO m_service VALUES (NULL, '180', '18', 'WEDDING MUSIC BOX', 'weddingMusicBox', 'https://office.weddmusicbox.com', 'CD（原盤）運用・単曲での権利処理が不要なウェデイング演出に特化したBGMサービス', '<p>結婚式シーンでの複雑なBGM利用および権利処理までワンストップ運用がオンラインで可能。<br/>簡潔で正確な運用化をオンラインで可能とし、「事業者さま」「新郎新婦さま」「披露宴会場」すべての課題解決をお手伝いするウェディング向けBGMサービスです。</p>', 'logo_wedding.png', 18, '0', '1', '0', 'SYSTEM', NOW(), 'SYSTEM', NOW());
