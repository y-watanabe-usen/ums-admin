...
export default class DemoSearchScreen extends AuthedScreen {
  get firstLoginId() {
    return this.driver
      .findElement(By.xpath('//*[@id="search_table"]/tbody/tr[1]/td[2]'))
      .getText();
  }

  get stoppedDate() {
    return this.driver
      .findElement(By.xpath('//*[@id="search_table"]/tbody/tr[1]/td[7]'))
      .getText();
  }
  ...
  async clickBtnDemoAccountStopSave() {
    await this.driver
      .findElement(By.xpath('//*[@id="pop_stop"]/div[2]/div[5]/button[1]'))
      .click();
    await this.driver.wait(
      until.elementLocated(
        By.xpath('//*[@id="search_table"]/tbody/tr[1]/td[7]')
      ),
      10000
    ); // 日付が表示されるまで待機
  }
